<!--
  Contenu éditable. Personnalise librement ce texte : ce sont des paragraphes de
  présentation professionnelle plausibles déduits du profil technique observé
  (dépôts backend Java/Spring/microservices + IoT), mais les détails biographiques
  (parcours, formation, dates, expériences) restent à préciser par toi-même.
-->
---
